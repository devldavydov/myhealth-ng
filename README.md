...
Приложение для ведения данных о здоровье: справочник продуктов с КБЖУ,
именованные наборы продуктов и пользовательская динамика веса. Backend — Go +
Gin + PostgreSQL, frontend — React + Vite.
...
| `GET` | `/api/bundle?q=...` | Список и поиск бандлов |
...
Интеграционные тесты очищают таблицы `food`, `bundle`, `bundle_item` и `weight`
в указанной тестовой базе. Не направляйте `TEST_DATABASE_URL` на базу с нужными
данными.
