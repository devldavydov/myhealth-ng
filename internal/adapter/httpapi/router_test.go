...
func TestWeightRoutesUseCurrentUserAndDateRange(t *testing.T) {
	...
	router := httpapi.NewRouter(&foodUseCasesStub{}, stub, httpapi.Options{})
...
func TestWeightValidationAndErrors(t *testing.T) {
	router := httpapi.NewRouter(&foodUseCasesStub{}, &weightUseCasesStub{}, httpapi.Options{})
	...
	notFound := httpapi.NewRouter(&foodUseCasesStub{}, &weightUseCasesStub{err: port.ErrWeightNotFound}, httpapi.Options{})
...
func TestRequireCertificate(t *testing.T) {
	router := httpapi.NewRouter(&foodUseCasesStub{}, &weightUseCasesStub{}, httpapi.Options{CertificateRequired: true})
...
func newRouter(stub port.FoodUseCases) http.Handler {
	...
	return httpapi.NewRouter(stub, &weightUseCasesStub{}, httpapi.Options{})
}
